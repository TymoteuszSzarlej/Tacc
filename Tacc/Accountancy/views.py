...
def financial_forecast(request):
    ...
    forecast_data = {
        ...
        'revenues': [total_revenues * (1 + 0.02 * i) for i in range(12)],
        'expenses': [total_expenses * (1 + 0.015 * i) for i in range(12)],
        'profits': [(total_revenues * (1 + 0.02 * i)) - (total_expenses * (1 + 0.015 * i)) for i in range(12)],
    }
